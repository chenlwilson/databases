...
describe('Persistent Node Chat Server', function() {
  ...
  it('Should insert posted messages to the DB', function(done) {
    ...
    request({
      ...
      request({
        ...
        var queryString = 'SELECT * FROM messages INNER JOIN users ON messages.id_users = users.id WHERE users.username = ?';
  ...
  it('Should output all messages from the DB', function(done) {
    ...
    var queryString = `INSERT INTO messages (messages, roomname) VALUES (?, ?)`;
